...
public static class DependencyModule
{
    public static IHostApplicationBuilder AddAncelaAgent(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddSingleton<FitbitPlugin>();
        builder.Services.AddSingleton<FitbitClient>();
        builder.Services.AddSingleton<IFitbitTokenStore, FitbitTokenStore>();
        builder.Services.AddSingleton(_ => FitbitCredentials.FromEnvironment());
        builder.Services.AddHttpClient("fitbit", c => c.BaseAddress = new Uri("https://api.fitbit.com"));
